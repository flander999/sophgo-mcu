...
#define MCU_SW_VER      12
#define SOC_NUM         2

#define false	0
#define true	1

#define PCIE_RESET_PORT PCIE0_RST_X_PORT
#define PCIE_RESET_PIN  PCIE0_RST_X_PIN
#define PCIE_RESET_EXTI PCIE0_RST_X_EXTI
#define PCIE_RESET_NVIC EXTI5_9_IRQn
...
#define FLASH_USED	(256 * 1024) // 232K, 0x0803A000

#define EEPROM_BASE	(FLASH_BASE + (FLASH_USED - FLASH_PAGE_SIZE * 4) )
#define EEPROM_SIZE	FLASH_BLOCK_MIN_SIZE
...
#define SN_PAGE_SIZE		(FLASH_PAGE_SIZE * 2)
#define SN_BASE			(FLASH_BASE + FLASH_USED - FLASH_PAGE_SIZE * 2)
#define SN_BASE_OFFSET		(FLASH_USED - FLASH_PAGE_SIZE * 2)
